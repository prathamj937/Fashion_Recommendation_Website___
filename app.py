...
app.config['MAIL_USERNAME'] = 'prathamj937@gmail.com'
app.config['MAIL_PASSWORD'] = 'Messipratham30'
...
# Function to analyze hair length (Dummy Analysis)
...
# Function to analyze face shape (Dummy Analysis)
...
# Function to analyze body shape (Dummy Analysis)
